                        ...
                        >
                            ...
                            >
                                @if ($settings->social_facebook)
                                    <li>
                                        <a class="social-link text" href="{{ $settings->social_facebook }}" target="_blank" rel="noreferrer">
                                ...
                                @if ($settings->social_linkedin)
                                    <li>
                                        <a class="social-link text" href="{{ $settings->social_linkedin }}" target="_blank" rel="noreferrer">
                                ...
                                @if ($settings->social_twitter)
                                    <li>
                                        <a class="social-link text" href="{{ $settings->social_twitter }}" target="_blank" rel="noreferrer">
                                ...
                                @if ($settings->social_instagram)
                                    <li>
                                        <a class="social-link text" href="{{ $settings->social_instagram }}" target="_blank" rel="noreferrer">
