                ...
                <div class="row footer-custom-row">
                    <div class="col-12 col-md-6">
                        ...
                        >
                            ...
                            >
                                <li>
                                    <a class="social-link text" href="{{ $settings->social_facebook ?? 'https://www.facebook.com/' }}" target="_blank" rel="noreferrer" aria-label="Facebook">
                                ...
                                <li>
                                    <a class="social-link text" href="{{ $settings->social_linkedin ?? 'https://www.linkedin.com/' }}" target="_blank" rel="noreferrer" aria-label="LinkedIn">
                                ...
                                <li>
                                    <a class="social-link text" href="{{ $settings->social_twitter ?? 'https://x.com/' }}" target="_blank" rel="noreferrer" aria-label="Twitter / X">
                                ...
                                <li>
                                    <a class="social-link text" href="{{ $settings->social_whatsapp ?? 'https://web.whatsapp.com/' }}" target="_blank" rel="noreferrer" aria-label="WhatsApp">
                        ...
                        >
                            ...
                            <ul class="footer-menu list-unstyled">
                                ...
                                @if ($settings->company_phone)
                                    <li><a href="tel:{{ $settings->company_phone }}" class="text text-16 link">{{ $settings->company_phone }}</a></li>
                                @endif
