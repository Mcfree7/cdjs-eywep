...
@section('title', 'Activités - ' . ($settings->company_name ?? 'EYWEP'))
@section('description', 'Découvrez toutes les activités organisées par ' . ($settings->company_name ?? 'EYWEP'))

@section('content')
<main>

    @include('front.partials.page-banner', ['bannerTitle' => 'Activités'])
            ...
            <div class="row product-grid">
                        ...
                        <div class="card-blog-top">
                            <div class="card-blog-meta">
                                ...
                                <div class="card-blog-meta-item text text-18">
                                    ...
                                    {{ $activity->datePublication->format('d M Y') }}
                                </div>
                                @endif
                            </div>
                ...
                <div class="col-12">
                    <div class="text-center py-5">
                        <p class="text text-18" style="color: var(--color-foreground-subheading);">Aucune activité disponible pour le moment.</p>
