    ...
    <section class="featured-blog section-padding mt-100">
        <div class="container">
            <div class="section-headings text-center mb-3">
                <div class="subheading text-20 subheading-bg" data-aos="fade-up">
                    <svg class="icon icon-14" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <g clip-path="url(#clip-stories-home)">
                            <path d="M8.71401 5.28599C11.7514 5.4205 14 5.9412 14 7C14 8.0588 11.7514 8.5795 8.71401 8.71401C8.5795 11.7514 8.0588 14 7 14C5.9412 14 5.4205 11.7514 5.28599 8.71401C2.2486 8.5795 0 8.0588 0 7C0 5.94119 2.2486 5.4205 5.28599 5.28599C5.4205 2.2486 5.9412 0 7 0C8.0588 0 8.5795 2.2486 8.71401 5.28599Z" fill="currentColor"/>
                        </g>
            ...
            <div class="success-stories-swiper swiper" data-aos="fade-up" data-aos-delay="100" style="padding-bottom: 50px;">
                <div class="swiper-wrapper">
                            ...
                            <div class="card-blog-top">
                                <div class="card-blog-meta">
                                    ...
                                    <div class="card-blog-meta-item text text-18">
                                        ...
                                        {{ $story->datePublication->translatedFormat('d M Y') }}
                                    </div>
                                    @endif
                                </div>
                                <h2 class="card-blog-heading heading text-22">
...
.success-stories-swiper .swiper-slide .card-blog {
    display: flex;
    flex-direction: column;
    height: 100%;
    width: 100%;
}
.success-stories-swiper .swiper-slide .card-blog-top {
    flex: 1;
}
.success-stories-swiper .swiper-slide .card-blog-heading a {
    display: -webkit-box;
    -webkit-line-clamp: 2;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var storiesEl = document.querySelector('.success-stories-swiper');
    if (storiesEl && typeof Swiper !== 'undefined') {
        new Swiper('.success-stories-swiper', {
            ...
            speed: 700,
            pagination: {
                el: '.success-stories-swiper .swiper-pagination',
                clickable: true,
            },
            navigation: {
                nextEl: '.success-stories-swiper .swiper-button-next',
                prevEl: '.success-stories-swiper .swiper-button-prev',
            },
            breakpoints: {
                768: {
                    slidesPerView: 2,
