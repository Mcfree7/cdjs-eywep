    ...
    <div class="container-fluid">
        ...
        <div class="activities-header d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="activities-title">
                <h3 class="mb-0">Modifier une activité</h3>
                <span class="activities-subtitle">Édition d'une activité existante</span>
            </div>
        ...
        <div class="container-fluid">
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">Edition de l'activite</h3>
                </div>
                ...
                <form action="{{ route('activities.update', $activity) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="titre" id="titre" class="form-control" value="{{ old('titre', $activity->titre) }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="description" class="form-label">Description</label>
                            <div class="editor-shell">
                                <textarea name="description" id="description" rows="10" class="form-control" required>{{ old('description', $activity->description) }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                @forelse ($activity->images as $image)
                                    @php
                                        ...
                                        $selectedCoverId = (int) old('cover_image_id', $activity->imageId);
                                    @endphp
                                    <div class="col-sm-6 col-md-4 col-lg-3">
                                        <div class="existing-image-card h-100">
                                            <img src="{{ $imageUrl }}" alt="Image activite {{ $image->id }}">
                                            <div class="p-3">
                                ...
                                @empty
                                    <div class="col-12">
                                        <div class="alert alert-secondary mb-0">Aucune image enregistree pour cette activite.</div>
                                    </div>
                                @endforelse
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-end mb-2">
                                <button type="button" id="clear-images" class="btn btn-sm btn-outline-danger d-none">
                                    Tout deselectionner
                                </button>
                            </div>
...
@push('scripts')
    <script>
        const initEditActivityPage = function () {
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', initEditActivityPage);
        } else {
            initEditActivityPage();
        }
    </script>
@endpush
