    ...
    <div class="container-fluid">
        ...
        <div class="activities-header d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="activities-title">
                <h3 class="mb-0">Créer une activité</h3>
                <span class="activities-subtitle">Ajouter une nouvelle activité</span>
            </div>
...
@push('scripts')
    <script>
        const initCreateActivityPage = function () {
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', initCreateActivityPage);
        } else {
            initCreateActivityPage();
        }
    </script>
@endpush
