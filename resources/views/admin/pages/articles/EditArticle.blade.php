    ...
    <div class="container-fluid">
        ...
        <div class="articles-header d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="articles-title">
                <h3 class="mb-0">Modifier un article</h3>
                <span class="articles-subtitle">Édition d'un article existant</span>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="editor-shell">
                                <textarea name="description" id="description" rows="10" class="form-control" required>{{ old('description', $article->description) }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                @forelse ($article->images as $image)
                                    @php
                                        ...
                                        $selectedCoverId = (int) old('cover_image_id', $article->imageId);
                                    @endphp
                                    <div class="col-sm-6 col-md-4 col-lg-3">
                                        <div class="existing-image-card h-100">
                                            <img src="{{ $imageUrl }}" alt="Image article {{ $image->id }}">
                                            <div class="p-3">
                                ...
                                @empty
                                    <div class="col-12">
                                        <div class="alert alert-secondary mb-0">Aucune image enregistree pour cet article.</div>
                                    </div>
                                @endforelse
                            </div>
                        </div>
...
@push('scripts')
    <script>
        const initEditArticlePage = function () {
            const form = document.querySelector('form[action="{{ route('articles.update', $article) }}"]');
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', initEditArticlePage);
        } else {
            initEditArticlePage();
        }
    </script>
