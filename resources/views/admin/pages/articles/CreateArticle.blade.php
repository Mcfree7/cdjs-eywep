    ...
    <div class="container-fluid">
        ...
        <div class="articles-header d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="articles-title">
                <h3 class="mb-0">Creer un article</h3>
                <span class="articles-subtitle">Ajouter un nouvel article</span>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                id="datePublication"
                                class="form-control"
                                value="{{ old('datePublication', $defaultPublicationDate) }}"
                            >
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <label for="images" id="upload-dropzone" class="upload-dropzone w-100">
                                ...
                                <small class="text-muted d-block">
                                    JPG, JPEG, PNG, WEBP. La premiere image envoyee sera definie comme image principale.
                                </small>
...
@push('scripts')
    <script>
        const initCreateArticlePage = function () {
            const form = document.querySelector('form[action="{{ route('articles.store') }}"]');
            ...
            if (!input || !preview || !dropzone || !selectionLabel) {
                return;
            }
            ...
            const renderPreview = function () {
                ...
                selectedFiles.forEach(function (file, index) {
                    ...
                    reader.onload = function (event) {
                        ...
                        const badge = index === 0
                            ? '<span class="badge text-bg-primary position-absolute top-0 start-0 m-2">Principale</span>'
                            : '';
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', initCreateArticlePage);
        } else {
            initCreateArticlePage();
        }
    </script>
@endpush
