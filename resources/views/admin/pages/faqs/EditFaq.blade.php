    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2"
                ...
                <div>
                    <h3 class="mb-0 fw-600" style="font-size:1.25rem;">Modifier la question</h3>
                    <span class="text-muted small">{{ \Illuminate\Support\Str::limit($faq->question, 60) }}</span>
                </div>
    ...
    <div class="app-content">
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header"><h3 class="card-title">Formulaire de modification</h3></div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="reponse" id="reponse" rows="5"
                                          class="form-control @error('reponse') is-invalid @enderror" required>{{ old('reponse', $faq->reponse) }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="ordre" id="ordre" class="form-control @error('ordre') is-invalid @enderror"
                                       value="{{ old('ordre', $faq->ordre) }}" min="0">
                            ...
                            <div class="col-md-4 d-flex align-items-center mt-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="actif" id="actif"
                                           value="1" {{ old('actif', $faq->actif) ? 'checked' : '' }}>
