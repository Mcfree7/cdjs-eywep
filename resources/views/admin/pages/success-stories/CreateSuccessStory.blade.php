    ...
    <div class="container-fluid">
        ...
        <div class="stories-header d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="stories-title">
                <h3 class="mb-0">Créer une success story</h3>
                <span class="stories-subtitle">Ajouter une nouvelle success story</span>
            </div>
...
@push('scripts')
    <script>
        const initCreateSuccessStoryPage = function () {
            const form = document.querySelector('form[action="{{ route('success-stories.store') }}"]');
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', initCreateSuccessStoryPage);
        } else {
            initCreateSuccessStoryPage();
        }
    </script>
@endpush
